 ...
 */
@WebServlet("/D_OTPverify")
public class D_OTPverify extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(Gotp==Uotp){
			RequestDispatcher rd=request.getRequestDispatcher("DriverRegister");  
...
//			RequestDispatcher rd=request.getRequestDispatcher("changePassword.jsp");
			...
			out.println("</script>");
			RequestDispatcher rd=request.getRequestDispatcher("D_OTPverify.jsp");
			rd.include(request, response);
		}
	}
