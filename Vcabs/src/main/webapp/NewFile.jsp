	...
	<head>
		...
		<%
			...
			if(session.getAttribute("Dname")==null){
				...
				obj.print("<style type=\"text/css\">#login{display: none;} #register{display: none;} #ride{display: none;} #Uprofile{display: none;}</style>");
				obj.print("<style type=\"text/css\">#items{ margin: 5px 3px -9px 0;}</style>");
				name =session.getAttribute("Dname").toString().toUpperCase();
				phone=session.getAttribute("Dphone"). toString();
				email=session.getAttribute("Demail").toString();
				vpn=session.getAttribute("Dvpn").toString();
			}								
		%>
	</head>
	        ...
	        <div class="card" style="margin-top:70px;margin-bottom: 60px;">
	        	<div class="card card-profile shadow ">
		              	...
		              	<div class="col-lg-3 order-lg-2">
			                <div class="card-profile-image ">
			                	<div id="profile-container">
			                    	<image id="profileImage" src="./Ddp" class="rounded-circle" style="width: 170px;height: 160px;">
			                	</div>
			                </div>
		              	</div>
		            </div>
            		...
            		<div class="card-body text-center" id="text-body-1">
            			<pre style="font-size:28px;margin-top:50px;"><span class="font-weight-bold">Name: </span><%=name %><br><span class="font-weight-bold">Mail Id: </span><%=email %><br><span class="font-weight-bold">Phone Number: </span><%=phone %><br><span class="font-weight-bold">Vehicle Plate Number: </span><%=vpn %>
            			</pre>
            		</div>


	          		<div class="card-body " id="text-body-2" style="display:none;">
	            		<form class="form" action="DriverProfile" method="post" enctype="multipart/form-data">
			                  	 	...
			                  	 	<div class="row">
						            	<div class="col-12 col-sm-auto mb-3" style="display: none;">
						                  	<div class="mx-auto" style="width: 140px;">
						                    	<div id="profile-container">
										       		<image id="profileImage" src="./Ddp" style="width: 150px;height: 150px;" />
										    	</div>
						                  	</div>
						                </div>
						            </div>
				                        ...
				                        <div class="row">
				                          <div class="col">
				                            <div class="form-group">
										        ...
										        <div class="input-group mb-2">
										            <input type="tel" class="form-control " id="phone" name="phone" pattern="[0-9]{10}" value="<%=phone %>" readonly />
										            <div class="input-group-prepend">
										            	<div class="input-group-text pencil-icon">
										                  	<i class="fa fa-pencil fa-lg" aria-hidden="true"></i>
										                </div>
				                        ...
				                        <div class="row">
				                          <div class="col">
				                            <div class="form-group">
										        ...
										        <div class="input-group mb-2">
										            <input type="text" class="form-control form-control-lg " id="vpn" name="vpn"
		                        		 		pattern="[A-Z]{2,3}-?[0-9]{2,3}-?[A-Z]{1,2}-?[0-9]{3,4}" required value="<%=vpn %>" readonly />
										            <div class="input-group-prepend">
										            	<div class="input-group-text pencil-icon">
										                  	<i class="fa fa-pencil fa-lg" aria-hidden="true"></i>
										                </div>
